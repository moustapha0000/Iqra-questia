...
import { Menu, X, BookOpen, Home, Star, MessageCircle, Heart, Info, ArrowRight, Download, Sun, Moon, HelpCircle, LogIn, LogOut, Trophy, User, BookMarked } from 'lucide-react';
